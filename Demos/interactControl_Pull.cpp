...
void makeWorld(CartWheel3D* p_simulator) {
    ...
    Point3d boxPosition(-0.1, 1.0, 4.5);
    ...
    p_simulator->addObject("boxHandle2", "data/objects/boxHandle.rbs", 5);
