...
namespace CartWheel {
    namespace Core {
         ...
         */
        class Controller : public CartWheel::Util::Observable {
        ...
        public:
            ...
            virtual void performPreTasks(double /* dt */, DynamicArray<CartWheel::Physics::ContactPoint> *cfs) {
                computeTorques(cfs);
                //std::cout << "computed Torques" << std::endl;
                applyTorques();
                //std::cout << "applied Torques" << std::endl;
            }

            // Returns true if it transitioned to a new state, false otherwise

            virtual bool performPostTasks(double /* dt */, DynamicArray<CartWheel::Physics::ContactPoint>* /* cfs */) {
                return false;
            }
             ...
             */
            virtual void computeTorques(DynamicArray<CartWheel::Physics::ContactPoint> *cfs) = 0;
